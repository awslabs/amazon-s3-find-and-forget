...
export default () => (
  <>
    ...
    <p className="separator-top">
      You can view the Data Mappers currently configured in this Amazon S3
      Find and Forget deployment. Data Mappers instruct the Amazon S3 Find and
      Forget solution how and where to search for items to be deleted. To
      configure a new Data Mapper, choose <strong>Create Data Mapper</strong>.
    </p>
    <p className="separator-bottom">
      ...
      choose a Data Mapper from the list then choose <strong>View S3
      Bucket Policy</strong>.
    </p>
    <h3>
